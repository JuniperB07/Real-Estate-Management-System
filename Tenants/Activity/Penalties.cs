...
namespace Real_Estate_Management_System.Tenants.Activity
{
    public partial class Penalties : Form
    {
        ...
        public Penalties(Form parent, Button opener)
        {
            InitializeComponent();
            Parent = parent;
            Opener = opener;
        ...
        private void Penalties_Shown(object sender, EventArgs e)
        {
        ...
        private void Penalties_FormClosed(object sender, FormClosedEventArgs e)
        {
