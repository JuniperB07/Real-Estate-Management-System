namespace Real_Estate_Management_System.Tenants.Activity
{
    partial class InvoiceHistory
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            dgvInvoiceHistory = new DataGridView();
            clmInvoiceNumber = new DataGridViewTextBoxColumn();
            clmBillType = new DataGridViewTextBoxColumn();
            clmInvoiceDate = new DataGridViewTextBoxColumn();
            clmDueDate = new DataGridViewTextBoxColumn();
            clmBillTotal = new DataGridViewTextBoxColumn();
            clmStatus = new DataGridViewTextBoxColumn();
            panel1.SuspendLayout();
            pnlDateRange.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dgvInvoiceHistory).BeginInit();
            SuspendLayout();
            // 
            // panel1
            // 
            ...
            // dgvInvoiceHistory
            // 
            dgvInvoiceHistory.AllowUserToAddRows = false;
            dgvInvoiceHistory.AllowUserToDeleteRows = false;
            dgvInvoiceHistory.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.DisplayedCells;
            dgvInvoiceHistory.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
            dgvInvoiceHistory.BackgroundColor = Color.FromArgb(240, 237, 229);
            dgvInvoiceHistory.BorderStyle = BorderStyle.None;
            dgvInvoiceHistory.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dataGridViewCellStyle1.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridViewCellStyle1.BackColor = Color.FromArgb(0, 70, 67);
            ...
            dgvInvoiceHistory.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            dgvInvoiceHistory.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvInvoiceHistory.Columns.AddRange(new DataGridViewColumn[] { clmInvoiceNumber, clmBillType, clmInvoiceDate, clmDueDate, clmBillTotal, clmStatus });
            ...
            dgvInvoiceHistory.DefaultCellStyle = dataGridViewCellStyle2;
            dgvInvoiceHistory.EnableHeadersVisualStyles = false;
            dgvInvoiceHistory.GridColor = Color.FromArgb(240, 237, 229);
            dgvInvoiceHistory.Location = new Point(280, 9);
            dgvInvoiceHistory.MultiSelect = false;
            dgvInvoiceHistory.Name = "dgvInvoiceHistory";
            dgvInvoiceHistory.ReadOnly = true;
            dgvInvoiceHistory.RowHeadersVisible = false;
            dgvInvoiceHistory.RowHeadersWidth = 51;
            dgvInvoiceHistory.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvInvoiceHistory.Size = new Size(877, 569);
            dgvInvoiceHistory.TabIndex = 1;
            // 
            // clmInvoiceNumber
            // 
            clmInvoiceNumber.HeaderText = "Invoice Number";
            clmInvoiceNumber.MinimumWidth = 6;
            clmInvoiceNumber.Name = "clmInvoiceNumber";
            clmInvoiceNumber.ReadOnly = true;
            clmInvoiceNumber.Width = 185;
            // 
            // clmBillType
            // 
            clmBillType.HeaderText = "Bill Type";
            clmBillType.MinimumWidth = 6;
            clmBillType.Name = "clmBillType";
            clmBillType.ReadOnly = true;
            clmBillType.Width = 119;
            // 
            // clmInvoiceDate
            // 
            clmInvoiceDate.HeaderText = "Invoice Date";
            clmInvoiceDate.MinimumWidth = 6;
            clmInvoiceDate.Name = "clmInvoiceDate";
            clmInvoiceDate.ReadOnly = true;
            clmInvoiceDate.Width = 154;
            // 
            // clmDueDate
            // 
            clmDueDate.HeaderText = "Due Date";
            clmDueDate.MinimumWidth = 6;
            clmDueDate.Name = "clmDueDate";
            clmDueDate.ReadOnly = true;
            clmDueDate.Width = 124;
            // 
            // clmBillTotal
            // 
            clmBillTotal.HeaderText = "Bill Total";
            clmBillTotal.MinimumWidth = 6;
            clmBillTotal.Name = "clmBillTotal";
            clmBillTotal.ReadOnly = true;
            clmBillTotal.Width = 120;
            // 
            // clmStatus
            // 
            ...
            Controls.Add(dgvInvoiceHistory);
            Controls.Add(panel1);
            ...
            FormClosing += InvoiceHistory_FormClosing;
            FormClosed += InvoiceHistory_FormClosed;
            Load += InvoiceHistory_Load;
            Shown += InvoiceHistory_Shown;
            panel1.ResumeLayout(false);
            pnlDateRange.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)dgvInvoiceHistory).EndInit();
            ResumeLayout(false);
        }
        ...
        private DataGridView dgvInvoiceHistory;
        ...
        private DataGridViewTextBoxColumn clmInvoiceNumber;
        private DataGridViewTextBoxColumn clmBillType;
        private DataGridViewTextBoxColumn clmInvoiceDate;
        private DataGridViewTextBoxColumn clmDueDate;
        private DataGridViewTextBoxColumn clmBillTotal;
