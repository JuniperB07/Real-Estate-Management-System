...
namespace Real_Estate_Management_System.Tenants.Activity
{
    public partial class Complaints : Form
    {
        ...
        public Complaints(Form parent, Button opener)
        {
            InitializeComponent();
            Parent = parent;
            Opener = opener;
        ...
        private void Complaints_Shown(object sender, EventArgs e)
        {
            Opener.BackColor = Internals.Cyprus_Active;
        }

        private void Complaints_FormClosing(object sender, FormClosingEventArgs e)
        {
            GC.Collect();
