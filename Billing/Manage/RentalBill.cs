...
namespace Real_Estate_Management_System.Billing.Manage
{
    public partial class RentalBill : Form
    {
        public RentalBill()
        {
            ...
            Forms.SetControlBackColor(Forms.ControlType<Button>.Extract(this), Color.FromArgb(65, 38, 102));
            ...
            Forms.SetControlForeColor(Forms.ControlType<TextBox>.Extract(this), Color.FromArgb(65, 38, 102));
